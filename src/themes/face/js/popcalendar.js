...
//  email : fuushikaden@yahoo.com
  ...
  var imgDir = "/afisha/kino/themes/default/images/calendar/" // directory for images ... e.g. var imgDir="/img/"
  ...
  if (dom)
  {
    ...
    document.write ("<div onclick='bShow=true' id='calendar'  style='z-index:+999;position:absolute;visibility:hidden;'><table  width="+
                    ...
                    " style='font-family:verdana;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:verdana; font-size:11px}' bgcolor='#ffffff'>"+
                    "<tr bgcolor='#0068B2'><td><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:verdana;font-size:11px;'><font color='#ffffff'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' WIDTH='15' HEIGHT='13' BORDER='0' ALT='Закрыть календарь' /></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='content'></span></td></tr>")
  ...
  function init() {
    if (!ns4)
    {
      ...
      sHTML1="<span id='spanLeft' style='border-style:solid;border-width:1px;border-color:#3366FF;cursor:pointer' onmouseover='swapImage(\"changeLeft\",\"left2.gif\");this.style.borderColor=\"#88AAFF\";self.status=\""+scrollLeftMessage+"\"' onclick='javascript:decMonth()' onmouseout='clearInterval(intervalID1);swapImage(\"changeLeft\",\"left1.gif\");this.style.borderColor=\"#3366FF\";self.status=\"\"' onmousedown='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"StartDecMonth()\",500)'  onmouseup='clearTimeout(timeoutID1);clearInterval(intervalID1)'>&nbsp;<a href='#' OnClick='return false;' title='"+scrollLeftMessage+"'><IMG id='changeLeft' SRC='"+imgDir+"left1.gif' width=10 height=11 BORDER=0></a>&nbsp;</span>&nbsp;"
      sHTML1+="<span id='spanRight' style='border-style:solid;border-width:1px;border-color:#3366FF;cursor:pointer' onmouseover='swapImage(\"changeRight\",\"right2.gif\");this.style.borderColor=\"#88AAFF\";self.status=\""+scrollRightMessage+"\"' onmouseout='clearInterval(intervalID1);swapImage(\"changeRight\",\"right1.gif\");this.style.borderColor=\"#3366FF\";self.status=\"\"' onclick='incMonth()' onmousedown='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"StartIncMonth()\",500)'  onmouseup='clearTimeout(timeoutID1);clearInterval(intervalID1)'>&nbsp;<a href='#' OnClick='return false;' title='"+scrollRightMessage+"'><IMG id='changeRight' SRC='"+imgDir+"right1.gif' width=10 height=11 BORDER=0></a>&nbsp;</span>&nbsp;"
      sHTML1+="<span id='spanMonth' style='border-style:solid;border-width:1px;border-color:#3366FF;cursor:pointer' onmouseover='swapImage(\"changeMonth\",\"drop2.gif\");this.style.borderColor=\"#88AAFF\";self.status=\""+selectMonthMessage+"\"' onmouseout='swapImage(\"changeMonth\",\"drop1.gif\");this.style.borderColor=\"#3366FF\";self.status=\"\"' onclick='popUpMonth()'></span>&nbsp;"
      sHTML1+="<span id='spanYear' style='border-style:solid;border-width:1px;border-color:#3366FF;cursor:pointer' onmouseover='swapImage(\"changeYear\",\"drop2.gif\");this.style.borderColor=\"#88AAFF\";self.status=\""+selectYearMessage+"\"' onmouseout='swapImage(\"changeYear\",\"drop1.gif\");this.style.borderColor=\"#3366FF\";self.status=\"\"'  onclick='popUpYear()'></span>&nbsp;"
  ...
  function constructMonth() {
    ...
    if (!monthConstructed) {
      ...
      document.getElementById("selectMonth").innerHTML = "<table width=70 style='font-family:verdana; font-size:11px; border-width:1; border-style:solid; border-color:#a0a0a0;' bgcolor='#f3f3f3' cellspacing=0 onmouseover='clearTimeout(timeoutID1)' onmouseout='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"popDownMonth()\",100);event.cancelBubble=true'>" + sHTML + "</table>"
  ...
  function constructYear() {
    ...
    if (!yearConstructed) {
      ...
      document.getElementById("selectYear").innerHTML = "<table width=44 style='font-family:verdana; font-size:11px; border-width:1; border-style:solid; border-color:#a0a0a0;' bgcolor='#f3f3f3' onmouseover='clearTimeout(timeoutID2)' onmouseout='clearTimeout(timeoutID2);timeoutID2=setTimeout(\"popDownYear()\",100)' cellspacing=0>" + sHTML + "</table>"
  ...
  function constructCalendar () {
    ...
    for (i=0; i<7; i++) {
      sHTML += "<td width='27' align='right' style='color:#356CA5; font-family: verdana'><B>"+ dayName[i]+"</B></td>"
    }
    sHTML +="</tr><tr>"
    ...
    document.getElementById("spanMonth").innerHTML = "<a style='text-decoration:none;color:#ffffff' href='#' OnClick='return false;' title='"+selectMonthMessage+"'>&nbsp;" + monthName[monthSelected] + "&nbsp;<IMG id='changeMonth' SRC='"+imgDir+"drop1.gif' WIDTH='12' HEIGHT='10' BORDER=0></a>"
    document.getElementById("spanYear").innerHTML = "<a style='text-decoration:none;color:#FFFFFF;' href='#' OnClick='return false;' title='"+selectYearMessage+"'>&nbsp;" + yearSelected + "&nbsp;<IMG id='changeYear' SRC='"+imgDir+"drop1.gif' WIDTH='12' HEIGHT='10' BORDER=0></a>"
  }
