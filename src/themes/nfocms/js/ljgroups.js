 ...
 {
     var rname = name;
     var index = name.lastIndexOf(" (общедоступная)");
     if (index != -1) {
 ...
 function deleteGroup ()
 {
     ...
     var conf = confirm("Вы уверены, что хотите удалить группу друзей?");
     if (!conf) { return; }
 ...
 function newGroup ()
 {
     ...
     if (!foundg) {
         alert("Вы достигли предельного количества из 30 групп друзей. Если вы удалили одну или несколько групп, но не сохранили изменения, сделайте это сейчас, вернитесь на эту страницу и перезагрузите её. После этого вы сможете создавать новые группы.");
         return;
     }
     var gnum = i;
