<?php
  ...
  $db_tree = &new DBTreeX ( $db,  "tree_store",  "tree_info" );
  $db_tree->tpl = &$tpl;
  $db_tree->tpf = 'tree.html';
  if ($_REQUEST['addwhat'])  { // echo BR.'_REQUEST : ';var_export($_REQUEST); // 'addwhat' => 'tagtag', 'addto' => 'beef', 'addto_id' => '6',
      if ( empty($_REQUEST['addto_id']) ) $_REQUEST['addto_id'] = 0;
  ...
  // $output_text = ob_get_contents();  ob_end_clean();
